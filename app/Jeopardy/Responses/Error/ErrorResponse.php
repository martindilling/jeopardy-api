...
class ErrorResponse extends ApiResponse
{
	...
	public function respondWithError($errorCode, $message, $details, $valErrors = null, $oldInput = null)
	{
		if ($this->statusCode >= 200 && $this->statusCode < 300) {
			trigger_error(
				"You proberbly shouldn't respond with an error with a successful status code[200-300]. Current code is [".$this->statusCode."]",
				E_USER_WARNING
			);
		}
	...
	public function doReplacements($error, $replace, $with)
	{
