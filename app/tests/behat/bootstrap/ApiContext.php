...
class ApiContext extends BehatContext
{
    ...
    public function iRequest($httpMethod, $resource)
    {
        ...
        try {
            switch ($httpMethod) {
                ...
                default:
                    $this->response = $this->client->$method($resource)->send();
            }
    ...
    public function thePropertyEquals($property, $expectedValue)
    {
        ...
        assertEquals($actualValue, $expectedValue, "Asserting the [$property] property in current scope equals [$expectedValue]: " . json_encode($payload));
    }
    ...
    public function thePropertyMustNotBePresent($property)
    {
        ...
        assertFalse(array_key_exists($property, $payload), "Asserting the [$property] property is NOT present in current scope [{$this->scope}]: " . json_encode($payload));
    }
    ...
    public function thePropertyIsAnArray($property)
    {
        ...
        assertTrue(is_array($actualValue), "Asserting the [$property] property in current scope [{$this->scope}] is an array: " . json_encode($payload));
    }
    ...
    public function thePropertyIsAnObject($property)
    {
        ...
        assertTrue(is_object($actualValue), "Asserting the [$property] property in current scope [{$this->scope}] is an object: " . json_encode($payload));
    }
    ...
    public function thePropertyIsAnEmptyArray($property)
    {
        ...
        assertTrue(is_array($scopePayload) and $scopePayload === [], "Asserting the [$property] property in current scope [{$this->scope}] is an empty array: " . json_encode($payload));
    }
    ...
    public function thePropertyIsAStringEqualling($property, $expectedValue)
    {
        ...
        assertSame($actualValue, $expectedValue, "Asserting the [$property] property in current scope [{$this->scope}] is a string equalling [$expectedValue].");
    }
    ...
    public function thePropertyIsAString($property)
    {
        ...
        isType('string', $this->arrayGet($payload, $property), "Asserting the [$property] property in current scope [{$this->scope}] is a string: " . json_encode($payload));
    }
    ...
    public function thePropertyIsABooleanEqualling($property, $expectedValue)
    {
        ...
        assertSame($actualValue, $expectedValue == 'true', "Asserting the [$property] property in current scope [{$this->scope}] is a boolean equalling [$expectedValue].");
    }
    ...
    public function thePropertyIsABoolean($property)
    {
        ...
        assertTrue(gettype($this->arrayGet($payload, $property)) == 'boolean', "Asserting the [$property] property in current scope [{$this->scope}] is a boolean.");
    }
    ...
    public function thePropertyIsAnInteger($property)
    {
        ...
        isType('int', $this->arrayGet($payload, $property), "Asserting the [$property] property in current scope [{$this->scope}] is an integer: " . json_encode($payload));
    }
    ...
    public function thePropertyIsEither($property, PyStringNode $options)
    {
        ...
        assertTrue(in_array($actualValue, $valid), sprintf("Asserting the [%s] property in current scope [{$this->scope}] is in array of valid options [%s].", $property, implode(', ', $valid)));
    }
    ...
    public function theValueExists($value)
    {
        ...
        $message = sprintf('Asserting the [%s] value exists in the scope [%s]: %s', $value, $this->scope, json_encode($payload));
